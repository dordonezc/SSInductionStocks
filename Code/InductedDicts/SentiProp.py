...
## Bad words
bad_words_data = pd.read_csv("Data/Seeds/Twitter_negative_seeds.csv")

## Filtered
bad_words_data = bad_words_data[bad_words_data["Color"] == "OK"]
bad_words = bad_words_data.name.values

## Good Words
good_words_data = pd.read_csv("Data/Seeds/Twitter_positive_seeds.csv")
good_words = good_words_data.name.values

## Read embeddings
w_embed = pd.read_csv("Data/Embeddings/TwitterTrained.csv")
...
## To Csv
df.to_csv("Data/InducedDicts/Twitter/PropPolaritiesTwitterTFiltered.csv", index = False)
